...
if __name__ == "__main__": 
    log_dir_path = KPI_CALC_REPO_PATH+'/interim-kpi-calculator/data/raw_ocpp_logs'
    output_file_path = KPI_CALC_REPO_PATH + '/interim-kpi-calculator/data/cleaned_logs/cleaned_format.csv'
